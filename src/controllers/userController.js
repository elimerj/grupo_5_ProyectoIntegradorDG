...
const imgArray = [
  ...
  'Avatar_default_5.jpg',
  'Avatar_default_6.jpg',
  'Avatar_default_7.jpg',
  'Avatar_default_8.jpg',
];
...
module.exports = {
      ...
      include: [
        {
          ...
          include: [{ association: 'images', where: { location: 'default' } }],
        },
      ],
    }).then((result) => {
      res.render('userCart', {
      ...
      db.Users.findOne({
        ...
        if (
          ...
          if (req.body.remember != undefined) {
            res.cookie('authRemember', result.username, {
              maxAge: 60000 * 10 * 5,
            });
          }
          return res.redirect('/');
        ...
        return res.render('userLogin', {
          errors: {
            usernamePass: {
              msg: 'Credenciales inválidas. Inserta un email o usuario registrado y su respectiva contraseña',
            },
          },
        });
      });
  ...
  edit: function (req, res) {
    db.Users.findByPk(req.params.id).then(function (result) {
      res.render('userEdit', {
        user: result,
      });
    });
      ...
      include: [
        {
          ...
          include: [
            {
              association: 'transactions_games',
        ...
        },
        {
          ...
          include: [
            { association: 'games', attributes: ['id', 'title', 'price'] },
            {
              association: 'users_sellers',
              attributes: ['id', 'username', 'email'],
            },
          ],
        },
        { association: 'games_shooping_cart', attributes: ['id', 'title'] },
      ],
    })
      .then(function (result) {
  ...
  transactionsForm: (req, res) => {
    db.Transactions.create({
      ...
      db.Games_Transactions.bulkCreate(games).then(function (result) {
        db.Games_Users.destroy({
          where: {
            id_user: req.params.id,
          },
